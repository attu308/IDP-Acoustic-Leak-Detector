...
| :---: | :--- | :---: | :---: | :--- |
| **1** | Title Slide | Atharv Deshpande | 0:30 min | Team intro, project scope, guide acknowledgement (Prof. Sujithra Kanmani). |
| **2** | Agenda | Atharv Deshpande | 0:30 min | Roadmap of presentation. |
| **3** | Introduction & Problem Statement | Ojas Sugur | 0:45 min | Non-Revenue Water (30-50% loss), micro-leak damage, limitations of manual patrols. |
| **4** | Literature Survey | Ojas Sugur | 0:45 min | Hunaidi et al. acoustic propagation, SCADA mass-balance limits, cloud logger costs. |
| **5** | Challenges & Research Gap | Vishwajeet Shelar | 0:45 min | Bandwidth bottlenecks (1.2 GB/day), acoustic impedance, bridging the ₹1,00,000 cost gap. |
| **6** | Project Objectives & Scope | Vishwajeet Shelar | 0:45 min | 5 concrete deliverables (Piezo sensing, DSP Log-Mel, Int8 TinyML, 12V actuation, MQTT). |
| **7** | Proposed Methodology & Architecture | Atharv Deshpande | 1:15 min | FreeRTOS Core 0 vs Core 1 task segregation, hardware trade-offs (ESP32-S3 vs RPi). |
...
> **Model Answer (Ojas Sugur / Atharv Deshpande):**  
...
> **Model Answer (Vishwajeet Shelar):**  
...
> **Model Answer (Vishwajeet Shelar / Atharv Deshpande):**  
...
> **Model Answer (Atharv Deshpande / Vishwajeet Shelar):**  
